...
#define NAV_SPEED_MIN              100          // cm/sec minimum navigational speed when NAV_SLOW_NAV is false
#define NAV_SPEED_MAX              600          // cm/sec maximum navigational speed
#define NAV_BANK_MAX               3000         // 20deg max banking when navigating (just for security and testing)
#define WP_RADIUS                  200          // Waypoint Radius, at which switch from nav to poshold happens
